...
void MIDI_write_global_header(FILE *fichier, unsigned char SMF, unsigned short pistes, unsigned short nbdiv)
{
    if ((SMF == 0) && (pistes > 1))
    {
...
void MIDI_add_tempo(FILE *fichier, unsigned long duree)
{
...
void MIDI_Note_unique_avec_duree(FILE *fichier, unsigned char canal, unsigned char Note_MIDI, unsigned char velocite, unsigned long duree)
{
    MIDI_delta_time(fichier, 0);
...
void MIDI_write_final_size_of_track(FILE *fichier, unsigned long marque)
{
